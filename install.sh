...
# ==================================================
# ZiVPN UDP Installer — Ris-Project Edition
# ==================================================
...
"wget -q https://raw.githubusercontent.com/Ris-Project/zipvpn/main/config.json \
...
"wget -q https://raw.githubusercontent.com/Ris-Project/zipvpn/main/zivpn-api.go \
-O /etc/zivpn/api/zivpn-api.go && \
wget -q https://raw.githubusercontent.com/Ris-Project/zipvpn/main/go.mod \
...
if [[ -n "$bot_token" && -n "$admin_id" ]]; then
  ...
  "wget -q https://raw.githubusercontent.com/Aryus09/zivpn09/main/zivpn-bot.go \

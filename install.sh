...
echo -e "${GRAY}Aryus-Project Edition${RESET}"
echo ""
...
"wget -q https://raw.githubusercontent.com/Aryus09/zivpn09/main/config.json -O /etc/zivpn/config.json"
...
-subj '/C=ID/ST=JawaBarat/L=Bekasi/O=Aryus-Project/OU=IT/CN=$domain' \
...
"wget -q https://raw.githubusercontent.com/Aryus09/zivpn09/main/zivpn-api.go -O /etc/zivpn/api/zivpn-api.go && \
 wget -q https://raw.githubusercontent.com/Aryus09/zivpn09/main/go.mod -O /etc/zivpn/api/go.mod"
...
if [[ -n "$bot_token" && -n "$admin_id" ]]; then
  ...
  "wget -q https://raw.githubusercontent.com/Aryus09/zivpn09/zipvpn/main/zivpn-bot.go -O /etc/zivpn/api/zivpn-bot.go"
